...
|---|---|---|---|---|
| TC1 | `movePiece`, `getBoard`, `getCurrentTurn` | White king castles kingside from e1 to g1; path f1/g1 clear; white rook on h1 | King moves to g1, rook moves to f1, e1/h1 empty, turn switches to BLACK | :x: |
