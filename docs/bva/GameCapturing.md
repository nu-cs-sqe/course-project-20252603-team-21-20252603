...
| TC5 | `movePiece`, `getBoard`, `getCurrentTurn` | WHITE knight captures BLACK pawn at board edge: WHITE knight is placed at `(2,2)`, BLACK pawn is placed at `(0,1)`, then `movePiece(2,2,0,1)` is called | BLACK pawn is removed, WHITE knight occupies `(0,1)`, start square `(2,2)` is empty, turn switches to BLACK | :white_check_mark: |
