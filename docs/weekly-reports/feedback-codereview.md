...
|                            | ❌     | 100% mutants should be killed (except for equivalent mutant).                                                                                                                   | Pitest is not set up in the main branch yet. |
|                            | ❌     | 100% cyclomatic coverage for non-GUI and non-enum code.                                                                                                                         | Jacoco is not set up in the main branch yet. |
...
### Other comments
Your commit history suggests that you probably have mutation testing and coverage set up locally, but it's not in the main branch yet. 
Please just update your build script in main asap :).
